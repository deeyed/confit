...
typedef struct ConfitTargetPlan {
  ...
  char *world_artifact_profile;
  char *world_boot_component;
  char *world_artifact_entry;
  char *world_artifact_linker_script;
  char **world_artifact_roles;
  size_t world_artifact_role_count;
